 ...
 *
 * Generated: 2011-09-14 11:32:02.187
 *
 */
...
MEMORY
{
    ...
    sram_UNUSED : ORIGIN = 0x00480000, LENGTH = 32
    sram : ORIGIN = 0x00480020, LENGTH = 524256
    sdram : ORIGIN = 0x00800000, LENGTH = 8388608
    epcs_flash_controller : ORIGIN = 0x00501800, LENGTH = 2048
    cfi_flash : ORIGIN = 0x00000020, LENGTH = 4194272
}

    /* Define symbols for each memory base-address */
 __alt_mem_sram = 0x00480000 ;
 __alt_mem_sdram = 0x00800000 ;
 __alt_mem_epcs_flash_controller = 0x00501800 ;
 __alt_mem_cfi_flash = 0x00000000 ;
...
PROVIDE( __alt_heap_limit    = 0x00500000 );
