...
#
# Generated: 2011-09-14 11:31:46.14
...
QUARTUS_PROJECT_DIR = E:/TAIWAN_SVN/mtl/cd/v1.0/Demonstrations/SOPC/DE2_SOPC_MTL_PAINTER
...
# macros defined by/for epcs_flash_controller & cfi_flash
...
flashfiles: $(EPCS_FLASH_CONTROLLER_BOOT_ROM_FLASHTARGET_ALT_SIM_PREFIX)epcs_flash_controller_boot_rom.flash $(CFI_FLASH_FLASHTARGET_ALT_SIM_PREFIX)cfi_flash.flash
.PHONY: flashfiles
...
dummy_verifysysid_file:
	nios2-download $(JTAG_CABLE)                                --sidp=0x02000060 --id=0 --timestamp=1313734521
